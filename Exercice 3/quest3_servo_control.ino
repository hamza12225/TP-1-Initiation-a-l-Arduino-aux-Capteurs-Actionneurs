...
void setup() {
  ...
  Serial.println("Controle Servo SG90");
...
void loop() {
  if (Serial.available() > 0) {
    ...
    switch (commande) {
      ...
      case '4': servoMoteur.write(90);  Serial.println("90 degres"); break;
      case '5': servoMoteur.write(120); Serial.println("120 degres"); break;
      case '6': servoMoteur.write(150); Serial.println("150 degres"); break;
      case '7': servoMoteur.write(180); Serial.println("180 degres"); break;
      default:
